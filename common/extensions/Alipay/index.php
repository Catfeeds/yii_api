...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=tradequery action=pagepay/query.php method=post
			target="_blank">
			<div id="body2" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dt></dt>
					<dd>
						<span style="line-height: 28px; color: red;">注意：商户订单号和支付宝交易号不能同时为空。
		...
		<form name=traderefund action=pagepay/refund.php method=post
			target="_blank">
		...
		<form name=traderefundquery action=pagepay/refundquery.php method=post
			target="_blank">
		...
		<form name=tradeclose action=pagepay/close.php method=post
			target="_blank">
