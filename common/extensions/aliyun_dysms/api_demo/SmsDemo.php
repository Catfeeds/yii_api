<?php
namespace common\extensions\aliyun_dysms\api_demo;
...
use backend\modules\mall\models\SmsLog;
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIFSe8HgiRGDnw"; // AccessKeyId

        $accessKeySecret = "9R8ilReAuTurZ5ALnEd3cIn7hVsiIz"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        $request->setSignName("身边的好消息");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_119081786");
