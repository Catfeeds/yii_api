...
use Yii;
use common\extensions\wxpay\lib\WxPayException;
use h5\modules\v1\service\WxPayConfig;
use common\extensions\wxpay\lib\WxPayResults;
use common\extensions\wxpay\lib\WxPayReport;
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(Yii::$app->params['wx_h5_pay']['appid']);//公众账号ID
		$inputObj->SetMch_id(Yii::$app->params['wx_h5_pay']['mchid']);//商户号
